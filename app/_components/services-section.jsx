...
export default function ServicesSection() {
  return (
    <section className="w-full relative ">
      <Wrapper className={"md:h-[110vh] h-[90vh] "}>
        <div className="md:rounded-[80px] rounded-[50px] h-full overflow-hidden bg-black py-[50px] px-[15px] relative">
          ...
          <div className=" flex w-full   md:flex-row flex-col justify-center items-center mt-9 md:mt-10 gap-y-4 md:gap-x-6 ">
            <div className="  md:w-[330px] md:h-[490px] w-[350px] h-[220px] flex flex-col item-center md:pt-[30px]">
              <div className=" flex md:justify-center  gap-3 text-mainColor md:text-[17px] font-semibold ">
                <h1>1: </h1>
            ...
            <div className="  md:w-[410px] md:h-[490px] w-[350px] h-[220px] flex flex-col items-center  md:pt-[30px]">
            <div className=" flex justify-center  gap-3 text-mainColor md:text-[17px] font-semibold md:pl-4">
                <h1>2: </h1>
            ...
            <div className="  md:w-[400px] md:h-[490px] w-[350px] h-[220px] flex flex-col items-center  md:pt-[30px]">
            <div className=" flex justify-center gap-3 text-mainColor md:pl-4 md:text-[17px] font-semibold">
                <h1>3: </h1>
